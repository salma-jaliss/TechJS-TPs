...
// Auto-play interval ID (null when not running)
let autoPlayIntervalId = null;

// Start or stop auto-play when the button is clicked
const autoPlayButton = document.querySelector('.js-auto-play-button');
if (autoPlayButton) {
  autoPlayButton.addEventListener('click', () => {
    if (autoPlayIntervalId === null) {
      // Start auto-play: run every 1000ms
      ...
      autoPlayIntervalId = setInterval(() => {
        ...
        playGame(playerMoves[randomIndex]);
      }, 1000);
    } else {
      // Stop auto-play
